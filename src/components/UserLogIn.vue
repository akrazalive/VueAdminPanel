<template>
  <div class="vue-template row">
    <form class="col-md-5 m-auto" @submit.prevent="signIn">
      <h3>Sign In</h3>
      ...
      <button type="submit" class="btn btn-sm btn-success btn-block mt-4">Sign In</button>
